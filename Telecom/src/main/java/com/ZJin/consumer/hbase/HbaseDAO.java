package com.ZJin.consumer.hbase;

import com.ZJin.consumer.utils.ConnectionInstance;
import com.ZJin.consumer.utils.HbaseUtil;
    ...
    public HbaseDAO() {
        try {
            ...
            if (!HbaseUtil.isExistTable(conf, tableName)) {
                HbaseUtil.initNs(conf, namespace);
